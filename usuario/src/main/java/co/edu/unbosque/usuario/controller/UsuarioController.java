...
public class UsuarioController {
	...
	public ResponseEntity<List<Notificacion>> listarNotificaciones(@PathVariable("usuarrioId") Long id){
		Usuario usuario = service.getUsuarioById(id);
		if(usuario == null){
			return ResponseEntity.notFound().build();
		}

		List<Notificacion> notificaciones = service.getNotificaciones(id);
